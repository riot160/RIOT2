...
export async function createSession(userId, phoneNumber = null, pairingMode = true) {
  ...
  const sock = makeWASocket({
    ...
    // ✅ FIX 1: Do NOT set browser — pairing codes require a mobile-type session.
    // Setting browser to Chrome/Web blocks pairing code generation entirely.
    markOnlineOnConnect: true,
    generateHighQualityLinkPreview: true,
    syncFullHistory: false,           // ✅ FIX 4: prevents history sync from blocking pairing
